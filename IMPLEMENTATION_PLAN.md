...
**Last updated**: Iteration 219
**Current focus**: Iteration 220 add durable bookmark tokens or filtered replay state above the shard/supervisor replay facade so reconnecting browser/editor consumers do not have to rebuild per-shard cursor maps by hand
...
**Next focus**: Add durable bookmark tokens or filtered replay state above the shard/supervisor replay facade so reconnecting browser/editor consumers do not have to rebuild per-shard cursor maps by hand.
