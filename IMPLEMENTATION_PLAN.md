...
**Last updated**: Iteration 217
**Current focus**: Iteration 218 add a browser/editor-friendly HTTP or WebSocket facade above the new authenticated shard/supervisor ops relay so external clients do not have to embed the raw TCP transport contract
