...
**Last updated**: Iteration 218
**Current focus**: Iteration 219 add replay/cursor semantics above the new shard/supervisor HTTP+SSE ops facade so browser/editor consumers can resume retained history without replaying the entire stream
...
**Next focus**: Add replay/cursor semantics or resumable stream state above the new HTTP/SSE facade so browser/editor consumers can attach late without replaying the full retained shard history on every reconnect.
