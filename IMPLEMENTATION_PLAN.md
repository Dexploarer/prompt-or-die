...
**Last updated**: Iteration 216
**Current focus**: Iteration 217 add an authenticated or streaming consumer-facing relay above the new process-external shard/supervisor archive query service so browser/editor/ops clients can do more than point-in-time retained-history fetches
