...
use super::entity_row_type::EntityRow;
...
pub struct EntityTableHandle<'ctx> {
    imp: __sdk::TableHandle<EntityRow>,
...
impl EntityTableAccess for super::RemoteTables {
    fn entity(&self) -> EntityTableHandle<'_> {
        EntityTableHandle {
            imp: self.imp.get_table::<EntityRow>("entity"),
...
impl<'ctx> __sdk::Table for EntityTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = EntityRow> + '_ {
        self.imp.iter()
    }
...
pub struct EntityEntityIdUnique<'ctx> {
    imp: __sdk::UniqueConstraintHandle<EntityRow, u64>,
...
impl<'ctx> EntityEntityIdUnique<'ctx> {
    ...
    pub fn find(&self, col_val: &u64) -> Option<EntityRow> {
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    let _table = client_cache.get_or_make_table::<EntityRow>("entity");
...
) -> __sdk::Result<__sdk::TableUpdate<EntityRow>> {
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse("TableUpdate<EntityRow>", "TableUpdate")
            .with_cause(e)
            .into()
    })
}
...
#[allow(non_camel_case_types)]
/// Extension trait for query builder access to the table `EntityRow`.
///
/// Implemented for [`__sdk::QueryTableAccessor`].
pub trait entityQueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `EntityRow`.
    fn entity(&self) -> __sdk::__query_builder::Table<EntityRow>;
}
